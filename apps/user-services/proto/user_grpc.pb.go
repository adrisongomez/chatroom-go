...
type UserServiceClient interface {
	...
	GetUsers(ctx context.Context, in *GetUsersRequests, opts ...grpc.CallOption) (UserService_GetUsersClient, error)
}
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *GetUsersRequests, opts ...grpc.CallOption) (UserService_GetUsersClient, error) {
...
type UserServiceServer interface {
	...
	GetUsers(*GetUsersRequests, UserService_GetUsersServer) error
...
func (UnimplementedUserServiceServer) GetUsers(*GetUsersRequests, UserService_GetUsersServer) error {
